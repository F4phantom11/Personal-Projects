...
class object {
 ...
 public:
  ...
  int get_hit(){return (int)hit;}
  int get_def(){return (int)defence;}
    int get_dog(){return (int)dodge;}
    int get_weight(){return (int) weight;}
  ...
  const std::string get_desc(){return description; }
};
